 ...
 * Genera catalog.xml compatible con Meta Commerce Manager (RSS 2.0 / Google Base)
 * leyendo la tabla `products` de Supabase.
 *
 * Uso local:
...
// ── Credenciales (Secrets de GitHub tienen prioridad; si no existen usa el valor directo) ──
...
// Categoría Google: Baby & Toddler Clothing
